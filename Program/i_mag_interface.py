...
class MainWindow(QMainWindow):
	...
	def show_history(self):
		...
		self.show_table_data(history, ['Название товара', 'Цена', 'Артикул', 'Имя покупателя', 'Фамилия покупателя', 'Скидка', 'Название магазина', 'Адрес магазина', 'Дата покупки'])

	def show_bought_products(self):
		bought_products = self.db.get_by_name(self.bought_products_name_lineedit.text(), self.bought_products_surname_lineedit.text())
		self.show_table_data(bought_products, ['Название товара', 'Цена', 'Арткул', 'Название магазина', 'Адрес магазина', 'Дата покупки'])

	def show_product_buyers(self):
		bought_products = self.db.get_by_article(self.product_buyers_article_lineedit.text())
		self.show_table_data(bought_products, ['Название товара', 'Цена', 'Фамилия покупателя', 'Имя покупателя', 'Скидка', 'Название магазина', 'Адрес магазина', 'Дата покупки'])
